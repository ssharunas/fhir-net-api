...
namespace Hl7.Fhir.Rest
{
	internal class RestUrl
	{
		...
		{
			if (keyValue is null) throw Error.ArgumentNull(nameof(keyValue));
		...
		{
			if (keyValues is null) throw Error.ArgumentNull(nameof(keyValues));
		...
		{
			if (path is null) throw Error.ArgumentNull(nameof(path));
